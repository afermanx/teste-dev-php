...
class UpdateSupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'document' => ['bail', 'sometimes', 'array:type,number'],
            ...
            'address' => ['bail', 'sometimes', 'array:street,number,complement,district,city,state,uf,zip_code'],
            ...
            'phone' => ['bail', 'sometimes', 'array:ddd,number'],
